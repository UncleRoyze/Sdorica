...
class Configuration(Singleton):
    ...
    def _initGlobalConfig(self):
        ...
        self.quest_jin2 = [Pattern("quest_guild_lv6-1.png").similar(0.95),Pattern("quest_guild_lv4-2.png").similar(0.95),Pattern("quest_lv8-1.png").similar(0.95),Pattern("quest_lv8-3.png").similar(0.95)]
