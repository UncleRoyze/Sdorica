...
class Configuration(Singleton):
    ...
    def _initGlobalConfig(self):
        ...
        self.quest_nolva = [Pattern("quest_guild_lv6-0.png").similar(0.95),Pattern("quest_guild_lv4-0.png").similar(0.95),Pattern("quest_guild_lv4-1.png").similar(0.95),Pattern("quest_guild_lv3-3.png").similar(0.95),Pattern("quest_guild_lv3-0.png").similar(0.95),Pattern("quest_guild_lv3-1.png").similar(0.95),Pattern("quest_guild_lv3-4.png").similar(0.95)]
