...
class Configuration(Singleton):
    ...
    def _initGlobalConfig(self):
        ...
        self.quest_jin2 = [Pattern("quest_20t.png").similar(0.95),Pattern("quest_treasure-1.png").exact(),Pattern("quest_guild_lv6-1.png").similar(0.95),Pattern("quest_guild_lv4-2.png").similar(0.95),Pattern("quest_lv8-1.png").similar(0.96),Pattern("quest_lv8-3.png").similar(0.96),Pattern("quest_lv8-4.png").similar(0.96),Pattern("quest_lv8-5.png").similar(0.96)]
